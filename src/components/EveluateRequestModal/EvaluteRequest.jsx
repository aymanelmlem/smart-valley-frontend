...
import { EvaluateRequest, RequestsEmp } from '../../redux/instructor/instructorSlice';
import { toast } from 'react-toastify';

export default function EvaluteRequest({ id, show, close }) {
    ...
    const EvaluateReq = async (values) => {
        ...
        const response = await dispatch(EvaluateRequest({ value: payload, id }));
        ...
        <Modal className='flex justify-center items-center' show={show} size='md' popup onClose={close}>
            ...
            <Modal.Body>
                <form onSubmit={formik.handleSubmit} className='space-y-6'>
                    ...
                    {formik.values.state === 'initiallyAccepted' && (
                        <>
                            <div className='mb-2 block'>
