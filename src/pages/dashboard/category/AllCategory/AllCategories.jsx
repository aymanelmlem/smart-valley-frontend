...
import {
  allCategoriesForUser,
  deleteCategory,
  filterCategoriesForAllUser,
  updateCategoryName,
  updateSupCategory,
...
export default function AllCategories() {
  ...
  const totalPages = ctgUser?.categories
    ? Math.ceil(ctgUser.categories.length / parseInt(numberOfPages))
    : 1;
      ...
      <ul className="m-0 p-0 list-unstyled flex">
        ...
        <li>
          <button
            className="bg-blue-800 cursor-pointer duration-300 transition-all hover:text-blue-900 hover:bg-transparent hover:outline-double hover:outline-blue-800 p-2 px-4 mx-1 rounded-md shadow-md text-white"
            disabled={
              currentPage === totalPages || !ctgUser?.categories?.length
            }
            onClick={() => setCurrentPage(currentPage + 1)}
          >
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="All Categories page" />
        <meta name="keywords" content="All Categories, elearning, education" />
                    ...
                    <div className="pb-4">
                      ...
                      {data.role == 'superAdmin' && (
                        <div className="bg-purple-700 absolute top-0 left-0 p-3 text-white shadow-xl m-5 rounded-lg cursor-pointer">
                          ...
                          {toggleMenu === item._id && (
                            <div className="absolute top-14 w-48   bg-gray-50 dark:bg-gray-700 shadow-md p-2 rounded-md">
                              <ul>
                                {data?.role == 'superAdmin' && (
                                  <>
                                    <li
                                      onClick={() => deleteCtg(item._id)}
                                      className="text-sm cursor-pointer dark:hover:bg-gray-600 hover:bg-gray-100 p-2 text-red-700 dark:text-red-500 font-bold"
                                    >
                                      Delete category
                                    </li>
                                    <li
                                      ...
                                      className="text-sm dark:hover:bg-gray-600 cursor-pointer hover:bg-teal-100 p-2 text-teal-600 dark:text-teal-400 font-bold"
                                    >
                                      Edit category
                                    </li>
                                    <li
                                      onClick={() =>
                                        toggleInputItem('supcategory')
                                      }
                                      className="text-sm cursor-pointer dark:hover:bg-gray-600 hover:bg-orange-100 p-2 text-orange-600 dark:text-orange-400 font-bold"
                                    >
                                      Add SubCategory
                                    </li>
                                    <li className="text-sm cursor-pointer hover:bg-rose-100 p-2 dark:hover:bg-gray-600 text-rose-600 dark:text-rose-400 font-bold">
                                      <Link
                                    ...
                                    <li className="text-sm cursor-pointer hover:bg-lime-100 p-2 dark:hover:bg-gray-600 text-lime-800 dark:text-lime-500 font-bold">
                                      <Link
                                ...
                                {toggeleInput.categoryInput && (
                                  <form className=" fixed text-black  top-24 right-10    w-[500px]   bg-gray-200 dark:bg-gray-900 dark:text-white  p-3 shadow-md rounded-md z-10 ">
                                    <div>
                                      ...
                                      <input
                                        ...
                                        className="w-full focus:ring-0 shadow-md rounded-lg p-3  mt-2 focus:outline-none  dark:bg-gray-800 dark:text-white focus:border-gray-500 border-gray-300 bg-white text-gray-800 placeholder-gray-500"
                                      />
                                    </div>
                                    <button
                                      onClick={() =>
                                  ...
                                  <form className=" fixed text-black  top-24 right-10    w-[500px] bg-gray-200 dark:bg-gray-900 dark:text-white  p-3 shadow-md rounded-md z-10">
                                    <div>
                                      ...
                                      <input
                                        ...
                                        placeholder="subcategory"
                                        className="w-full focus:ring-0 shadow-md rounded-lg p-3  mt-2 focus:outline-none focus:border-gray-500  dark:bg-gray-900 dark:text-white border-gray-300 bg-white text-gray-800 placeholder-gray-500"
                                      />
                                    </div>
                                    <button
                                      type="button"
                      ...
                      >
                        ...
                        <td className="px-6 py-4">
                          <div className="flex items-center space-x-2">
                            <span className="dark:bg-gray-800 bg-gray-700 px-3 py-1 rounded-md capitalize">
                        ...
                        {data.role == 'superAdmin' && (
                          <td className="px-6 py-4 relative">
                            ...
                            ></i>
                            {toggleMenu === item._id && (
                              <div className="bg-gray-50 dark:bg-gray-800 shadow-md p-2 w-48  absolute z-20 right-14  rounded-md ">
                                <ul>
                                  {data.role == 'superAdmin' ? (
                                    <li
                                      onClick={() => deleteCtg(item._id)}
                                      className="text-sm cursor-pointer dark:hover:bg-gray-700  hover:bg-gray-100 p-2 text-red-700 dark:text-red-400  font-bold"
                                    >
                                      Delete category
                                    </li>
                                  ) : (
                                  ...
                                  <li
                                    ...
                                    className="text-sm cursor-pointer hover:bg-teal-100 p-2 text-teal-600 dark:text-teal-400  font-bold dark:hover:bg-gray-700 "
                                  >
                                    Edit category
                                  </li>
                                  <li
                                    ...
                                    className="text-sm cursor-pointer hover:bg-orange-100 p-2 text-orange-600 dark:text-orange-400 dark:hover:bg-gray-700   font-bold"
                                  >
                                    Add SubCategory
                                  </li>
                                  <li className="text-sm cursor-pointer hover:bg-rose-100 dark:hover:bg-gray-700 p-2 text-rose-600 dark:text-rose-400  font-bold ">
                                    <Link
                                      to={`/panel/delsubcategory?categoryId=${
                                        item._id
                                      }&subCategory=${encodeURIComponent(
                                  ...
                                  <li className="text-sm cursor-pointer hover:bg-lime-100 dark:hover:bg-gray-700  p-2 text-lime-800 dark:text-lime-400  font-bold ">
                                    <Link
                                      to={`/panel/updateSubCategory?categoryId=${
                                        item._id
                                      }&subCategory=${encodeURIComponent(
                                  ...
                                  {toggeleInput.categoryInput && (
                                    <form className="z-20 grid w-[500px] gap-4 absolute -left-full top-0 transform -translate-x-full mt-4 -translate-y-24 bg-gray-200 dark:bg-gray-800 p-3 shadow-md rounded-md">
                                      <div>
                                        <label htmlFor="category">
                                          Category Name
                                        </label>
                                        <input
                                          ...
                                          className="w-full focus:ring-0 shadow-md rounded-lg p-3 pl-10 mt-2 focus:outline-none focus:border-gray-500 dark:bg-gray-700 dark:text-gray-200 border-gray-300 bg-white text-gray-800 placeholder-gray-500"
                                        />
                                      </div>
                                      <button
                                        onClick={() =>
                                  ...
                                  {toggeleInput.supcategory && (
                                    <form className="z-20 grid w-[500px] gap-4 absolute -left-full top-0 transform -translate-x-full mt-4 -translate-y-24  bg-gray-200 dark:text-white dark:bg-gray-800 p-3 shadow-md rounded-md">
                                      <div>
                                        <label htmlFor="subCategory">
                                          SubCategory Name
                                        </label>
                                        <input
                                          ...
                                          onChange={handleChange}
                                          className="w-full focus:ring-0 shadow-md rounded-lg p-3 pl-10 mt-2 focus:outline-none  focus:border-gray-500 border-gray-300 bg-gray-200 dark:bg-gray-800 text-gray-800 dark:text-white placeholder-gray-500"
                                        />
                                      </div>
                                      <button
                                        type="button"
